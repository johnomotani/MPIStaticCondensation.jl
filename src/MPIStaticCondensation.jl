...
function update_condensed_factorization!(cf::CondensedFactorization{T}, A::AbstractMatrix{T}, timer) where T
  n = cf.n
  @assert size(A) == (n, n)
...
@timeit timer "dense localblock factorizations" begin
  ...
  if sparse_local_blocks
@timeit timer "sparse ainv_dot_b" begin
...
@timeit timer "dense ainv_dot_b" begin
